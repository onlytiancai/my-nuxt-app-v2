...
#### [Alternative: Simple Setup](#alternative-simple-setup)
...
### [Organizing Your Tests](#organizing-your-tests)
...
#### [TypeScript Support in Tests](#typescript-support-in-tests)
...
[](https://github.com/nuxt/test-utils/blob/main/examples/app-playwright/playwright.config.ts)Read more in See full example config.
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/1.getting-started/17.testing.md)
