          ...
          <div class="flex items-center gap-6">
            ...
            <div class="flex-1">
              ...
              <p class="text-white/60 text-sm mt-1">
                注册时间：{{ formatDate(session?.createdAt) }}
              </p>
            </div>
            <UButton
              color="white"
...
const { ready, loggedIn, user, session, fetch: fetchUserSession, clear: clearSession } = useUserSession()
...
const hasPassword = computed(() => {
  // 从 session 中判断，如果有 password 字段说明设置了密码
